...
plot 'data/plotTrieHybride' using 2:3
Y_MAX=GPVAL_Y_MAX
Y_MIN=GPVAL_Y_MIN
...
plot 'data/plotTrieHybride' using 2:3 with linespoints ls 1 notitle, \
	'data/plotTrieHybride' using 2:3:1 with labels notitle tc rgb "white" offset 0
